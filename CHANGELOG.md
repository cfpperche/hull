...
- ADR-0004 states Postgres as the **default** store with an explicit escape hatch, not a ban. A rule with no way out gets ignored rather than argued with, and then the dependency arrives anyway, undocumented.
